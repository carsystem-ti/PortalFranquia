<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Encerradas.ascx.cs" Inherits="PortalFranquia.modulos.Chamados.Encerradas" %>
...
<fieldset style="width: 994px;margin-left:8%">
    <legend>Chamados em Encerrados</legend>
    <br />
