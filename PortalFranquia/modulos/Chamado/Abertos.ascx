<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Abertos.ascx.cs" Inherits="PortalFranquia.modulos.Chamados.Abertos" %>
...
<fieldset style="width: 994px;margin-left: 8%">
    <legend>Aguardando Atendimento</legend>
    <br />
