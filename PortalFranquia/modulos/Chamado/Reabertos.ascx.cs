...
{
    public partial class Reabertos : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                //Session["id_statusChamado"] = 5;
        ...
        public void BuscaChamados()
        {
            try
            {
                if (Session["acessoLogin"] != null)
                {
                    ...
                    dt = bda.GetChamados(id_franquia, 5);
        ...
        public void BuscaChamadosSuporte(int departamento)
        {
            try
            {
                if (Session["acessoLogin"] != null)
                {
                    ...
                    dt = bda.getChamadosSuportes(departamento, 5);
