...
{
    public partial class Abertos : System.Web.UI.UserControl
    {
        ...
        public void BuscaChamadosSuporte(int departamento)
        {
            try
            {
                if (Session["acessoLogin"] != null)
                {
                    ...
                    dt = bda.getChamadosSuportes(departamento, 1);
        ...
        public void BuscaChamados()
        {
            try
            {
                if (Session["acessoLogin"] != null)
                {
                    ...
                    dt = bda.GetChamados(id_franquia, 1);
